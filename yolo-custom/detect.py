...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="weights/yolov3-tiny.pth", help="path to weights file")
    ...
    dataloader = torch.utils.data.DataLoader(
        datasets.ImageFolder(opt.image_folder, img_size=opt.img_size),
        batch_size=opt.batch_size,
        shuffle=False,
        num_workers=opt.n_cpu,
    )
    classes = parse_config.load_classes(opt.class_path)
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        inference_time = datetime.timedelta(seconds=current_time - starttime)
